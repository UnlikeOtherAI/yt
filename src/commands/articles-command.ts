...
const generateAction = async (options: ArticleOptions) => {
...
export const registerArticlesCommand = (program: Command) => {
  program
    .command("articles")
    .description("Generate fidelity-preserving article versions of stored transcripts.")
    .command("generate")
    .description("Generate article output for a YouTube channel.")
